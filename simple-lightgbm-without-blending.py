...
def train_test(num_rows=None):
    ...
    # load csv
    train_df = pd.read_csv('inputs/train.csv', index_col=['card_id'], nrows=num_rows)
    test_df = pd.read_csv('inputs/test.csv', index_col=['card_id'], nrows=num_rows)
...
def historical_transactions(num_rows=None):
    # load csv
    hist_df = pd.read_csv('inputs/historical_transactions.csv', nrows=num_rows)
...
def new_merchant_transactions(num_rows=None):
    # load csv
    new_merchant_df = pd.read_csv('inputs/new_merchant_transactions.csv', nrows=num_rows)
